  ...
  const examples = [
    {
      ...
      examples: [
        ...
        { query: 'applicationDateStart:2024-01-15', description: 'Applicants who applied today' },
        { query: 'applicationDateStart:2024-01-08', description: 'Applicants who applied this week' },
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  ...
                  <div className="text-sm">
                    <code className="bg-green-100 dark:bg-green-900 px-1 rounded">not-applied</code> - Find Applicants without positions
                  </div>
                </div>
              </div>
            </div>
