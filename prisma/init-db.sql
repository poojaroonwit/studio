...
VALUES 
  ...
  ('00000000-0000-0000-0000-000000000004', 'Pre-Registered User', 'Minimal permissions for pre-registered AD users - login and view own profile only', ARRAY['USER_PREFERENCES_MANAGE_OWN'], false, true, NOW(), NOW())
