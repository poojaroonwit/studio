...
export async function clockOwnAttendance(
  ...
  input: EssAttendanceActionInput,
) {
  const employee = await requireEmployee(userId, email);
  const now = new Date();
...
export async function updateOwnLearning(userId: string, email: string | null | undefined, input: EssLearningPatchInput) {
  const employee = await requireEmployee(userId, email);
...
export async function updateOwnOnboarding(userId: string, email: string | null | undefined, input: EssOnboardingPatchInput) {
  const employee = await requireEmployee(userId, email);
...
export async function applyTeamAction(userId: string, email: string | null | undefined, input: EssTeamActionInput) {
  const manager = await requireEmployee(userId, email);
