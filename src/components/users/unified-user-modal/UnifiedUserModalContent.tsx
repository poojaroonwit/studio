...
import { Loader2, Mail, Briefcase, Save, Check } from 'lucide-react';
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col h-full bg-background/50">
            <div className="border-b-2 border-zinc-200 dark:border-zinc-800 px-6 bg-background/95 backdrop-blur-sm sticky top-0 z-10 w-full">
              <TabsList className="h-12 bg-transparent p-0 gap-6 w-full justify-start overflow-x-auto no-scrollbar">
                <TabsTrigger
                  value="personal"
                  className="h-12 !rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-2 font-medium transition-all text-muted-foreground data-[state=active]:text-foreground hover:text-foreground relative bottom-[-2px] z-10"
                >
                   Personal Info
                </TabsTrigger>
                <TabsTrigger
