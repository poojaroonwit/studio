...
## The Story of Finding the Fit

| Feature | Description |
| :--- | :--- |
| **What** | The end-to-end system for configuring, scheduling, and conducting interviews. |
...
*   **Location**: **Settings > Evaluation Configuration**.
1.  **Expertise Skills**: Define hard skills (e.g., "Python", "System Design") to be rated.
2.  **Personality Traits**: Define soft skills (e.g., "Communication", "Leadership").
3.  **Scorecards**: Create templates (e.g., "Technical Screen") mixing these skills.

## 2. Setting Up a Position (Recruiter)
Tailor the interview plan for a specific role.
1.  Open **Position Drawer > Interview Team**.
2.  **Add Interviewers**: Select users who will conduct the interviews.
3.  **Assign Skills**: (Optional) Assign specific skills to specific interviewers (e.g., "John checks Python", "Sarah checks Culture").
