...
export const HEADER_PAGE_RESULTS: HeaderSearchPageResult[] = [
  ...
  { id: 'page-appraisal', title: 'Appraisal', subtitle: 'Formal review cycles', href: '/workforce/appraisal', permissionIds: ['HR_PERFORMANCE_VIEW', 'HR_PERFORMANCE_MANAGE'] },
  ...
  { id: 'page-financial-dimensions', title: 'Financial Dimensions', subtitle: 'Cost centers and project codes', href: '/settings/financial-dimensions', permissionIds: ['SYSTEM_SETTINGS_VIEW', 'SYSTEM_SETTINGS_EDIT'] },
