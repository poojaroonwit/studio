...
## 1. Data Preservation
- **Audit Diff**: Every change to a Candidate or Position record is logged with a "Before" and "After" snapshot.
...
2.  **Act**: Perform a change in any candidate profile (e.g., change the phone number) and save.
