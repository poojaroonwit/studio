...
export const DEFAULT_LOGIN_BG_GRADIENT = 'linear-gradient(135deg, hsl(220 78% 28%) 0%, hsl(222 72% 36%) 100%)';
export const DEFAULT_LOGIN_BG_GRADIENT_DARK = 'linear-gradient(90deg, hsl(220, 15%, 9%) 0%, hsl(220, 15%, 11%) 100%, hsl(220, 15%, 10%) 55%)';
export const DEFAULT_LOGIN_LAYOUT_TYPE: LoginPageLayoutType = 'center';
...
export const LEGACY_LOGIN_BG_TYPE_KEY = 'loginPageBackgroundType';
export const LEGACY_LOGIN_BG_COLOR1_KEY = 'loginPageBackgroundColor1';
export const LEGACY_LOGIN_BG_COLOR2_KEY = 'loginPageBackgroundColor2';
