  ...
  theme: {
  	extend: {
  		...
  		textDecoration: {
			...
			'inter': ['var(--font-inter)', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Arial', 'Helvetica', 'sans-serif'],
			'roboto': ['var(--font-roboto)', 'Roboto', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Arial', 'Helvetica', 'sans-serif'],
			'open-sans': ['var(--font-open-sans)', 'Open Sans', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Arial', 'Helvetica', 'sans-serif'],
			'montserrat': ['var(--font-montserrat)', 'Montserrat', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Arial', 'Helvetica', 'sans-serif'],
			'ibm-plex-sans-thai': ['var(--font-ibm-plex-sans-thai)', 'var(--font-inter)', 'var(--font-noto-sans-thai)', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Tahoma', 'Arial', 'Helvetica', 'sans-serif'],
			'thai': ['var(--font-ibm-plex-sans-thai)', 'var(--font-inter)', 'var(--font-noto-sans-thai)', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Tahoma', 'Arial', 'Helvetica', 'sans-serif'],
			'english': ['var(--font-inter)', 'var(--font-roboto)', 'var(--font-open-sans)', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Arial', 'Helvetica', 'sans-serif'],
			'sans': ['-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'var(--font-roboto)', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'var(--font-inter)', 'var(--font-open-sans)', 'var(--font-montserrat)', 'var(--font-ibm-plex-sans-thai)', 'var(--font-noto-sans-thai)', 'Arial', 'Helvetica', 'sans-serif'],
		},
  		padding: {
