...
export MINIO_BUCKET_NAME=${MINIO_BUCKET_NAME:-studio-production}
export MINIO_ROOT_USER=${MINIO_ROOT_USER:-minioadmin}
export MINIO_ROOT_PASSWORD=${MINIO_ROOT_PASSWORD:-minioadmin}

# Debug: Print MinIO connection details (without password)
echo "🔍 MinIO connection details:"
...
echo "🔓 Creating bucket and setting public read policy on bucket: $MINIO_BUCKET_NAME"
mc mb myminio/"$MINIO_BUCKET_NAME" 2>/dev/null || {
  echo "⚠️  Bucket creation failed or bucket already exists, continuing..."
}
