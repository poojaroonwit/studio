      ...
      adminGroup = await prisma.userGroup.update({
        ...
        data: {
          ...
          permissions: [
            ...
            'CANDIDATES_VIEW','CANDIDATES_VIEW_DETAILED','CANDIDATES_CREATE','CANDIDATES_EDIT_BASIC','CANDIDATES_EDIT_SENSITIVE','CANDIDATES_EDIT_BASIC_OWN','CANDIDATES_EDIT_SENSITIVE_OWN','CANDIDATES_DELETE','CANDIDATES_SOURCE_ASSIGN','CANDIDATES_SOURCE_ASSIGN_BULK','CANDIDATES_RECRUITER_ASSIGN','CANDIDATES_RECRUITER_ASSIGN_BULK','CANDIDATES_RECRUITER_ASSIGN_OWN','CANDIDATES_PIPELINE_STAGE_UPDATE','CANDIDATES_PIPELINE_STAGE_BULK_UPDATE','CANDIDATES_PIPELINE_STAGE_UPDATE_OWN','CANDIDATES_RESUMES_UPLOAD','CANDIDATES_RESUMES_UPLOAD_OWN','CANDIDATES_RESUMES_DELETE','CANDIDATES_COMMENTS_VIEW','CANDIDATES_COMMENTS_ADD','CANDIDATES_COMMENTS_ADD_OWN','CANDIDATES_COMMENTS_EDIT','CANDIDATES_IMPORT','CANDIDATES_EXPORT',
      ...
      recruiterGroup = await prisma.userGroup.update({
        ...
        data: {
          ...
          permissions: [
            ...
            'CANDIDATES_VIEW','CANDIDATES_VIEW_DETAILED','CANDIDATES_CREATE','CANDIDATES_EDIT_BASIC','CANDIDATES_EDIT_BASIC_OWN','CANDIDATES_SOURCE_ASSIGN','CANDIDATES_RECRUITER_ASSIGN','CANDIDATES_RECRUITER_ASSIGN_OWN','CANDIDATES_PIPELINE_STAGE_UPDATE','CANDIDATES_PIPELINE_STAGE_UPDATE_OWN','CANDIDATES_RESUMES_UPLOAD','CANDIDATES_RESUMES_UPLOAD_OWN','CANDIDATES_COMMENTS_VIEW','CANDIDATES_COMMENTS_ADD','CANDIDATES_COMMENTS_ADD_OWN','CANDIDATES_IMPORT','CANDIDATES_EXPORT',
            // Position management
