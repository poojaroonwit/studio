...
export async function GET() {
  ...
  const employees = await prisma.$queryRaw<Array<{ id: string; employeeNumber: string; firstName: string; lastName: string; preferredName: string | null; jobTitle: string | null; departmentName: string | null }>>`
