# FitScan Migration & Data Transition Guide

This document outlines the procedures for migrating database schemas, file storage (MinIO), and seeding initial system data across different environments.
...
## ☁️ File Storage Migration (MinIO)
