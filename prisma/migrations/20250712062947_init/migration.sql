...
-- CreateIndex
CREATE INDEX "WebhookFieldMapping_target_path_idx" ON "WebhookFieldMapping"("target_path");

-- CreateIndex
CREATE UNIQUE INDEX "NotificationEvent_event_key_key" ON "NotificationEvent"("event_key");

-- CreateIndex
CREATE INDEX "NotificationEvent_event_key_idx" ON "NotificationEvent"("event_key");

-- CreateIndex
CREATE UNIQUE INDEX "NotificationChannel_channel_key_key" ON "NotificationChannel"("channel_key");

-- CreateIndex
CREATE INDEX "NotificationChannel_channel_key_idx" ON "NotificationChannel"("channel_key");

-- CreateIndex
CREATE INDEX "NotificationSetting_event_id_idx" ON "NotificationSetting"("event_id");

-- CreateIndex
CREATE INDEX "NotificationSetting_channel_id_idx" ON "NotificationSetting"("channel_id");

-- CreateIndex
CREATE INDEX "NotificationSetting_is_enabled_idx" ON "NotificationSetting"("is_enabled");
...
-- AddForeignKey
ALTER TABLE "NotificationSetting" ADD CONSTRAINT "NotificationSetting_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "NotificationEvent"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "NotificationSetting" ADD CONSTRAINT "NotificationSetting_channel_id_fkey" FOREIGN KEY ("channel_id") REFERENCES "NotificationChannel"("id") ON DELETE CASCADE ON UPDATE CASCADE;
