      ...
      >
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
          <div className="relative flex min-w-0 flex-1 flex-col overflow-hidden bg-transparent">
            ...
            >
              <section className="min-h-full w-full min-w-0 bg-background lg:rounded-[24px] lg:border lg:border-slate-200/80 lg:bg-white/95 lg:shadow-[0_18px_48px_rgba(15,23,42,0.08)] dark:lg:border-zinc-800 dark:lg:bg-zinc-950/95 dark:lg:shadow-[0_18px_48px_rgba(0,0,0,0.28)]">
