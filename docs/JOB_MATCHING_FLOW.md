# FitScan AI Job Matching Flow

The AI Matching system automates the first layer of screening by comparing candidate profiles against multiple open positions concurrently.
