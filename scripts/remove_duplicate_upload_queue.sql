...
-- 
-- Usage: psql "$DATABASE_URL" -f scripts/remove_duplicate_upload_queue.sql
...
SELECT 
  'Current duplicate upload queue entries:' as status,
...
-- INSERT INTO upload_queue SELECT * FROM upload_queue_backup;
-- DROP TABLE upload_queue_backup;
