...
import { Briefcase, Cloud, Loader2, Users } from "lucide-react";
        ...
        <div className={cn(isMobile ? "p-4 pb-48" : "p-6")}>
          <div className="mb-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Listing employees in Azure Active Directory with the job title "{positionTitle}"
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center p-12 border border-dashed rounded-lg bg-background">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                We couldn't find any active users in Azure AD with the exact job title "{positionTitle}".
              </p>
            </div>
          ) : (
