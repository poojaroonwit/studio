...
export function ApplicantScoreDistributionChart({ Applicants, initialData, isLoading = false, dynamicHeight }: ApplicantScoreDistributionChartProps) {
  ...
  const ApplicantscoreRanges = useMemo(() => {
    ...
    return rangeCounts;
  }, [filteredApplicants, initialData, periodType, periodUnit, periodN]);
    ...
    <Card className="shadow-sm hover:shadow-md transition-all duration-200">
      <CardHeader className="pb-3 md:z-auto z-10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Select value={periodType} onValueChange={(value: 'today'|'yesterday'|'lastN'|'this'|'pastN'|'custom') => setPeriodType(value)}>
            ...
            {(periodType === 'lastN' || periodType === 'pastN') && (
              <>
                ...
                <Select value={periodUnit} onValueChange={(value: 'day'|'week'|'month'|'year') => setPeriodUnit(value)}>
