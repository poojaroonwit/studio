            ...
            <FormItem>
              <FormControl>
                ...
                >
                  ...
                  <SelectContent selectId="redesigned-user-team-select">
                    {userTeams.map((group) => (
            ...
            <FormItem>
              ...
              {mode === 'profile' ? (
                ...
                >
                  ...
                  <SelectContent selectId="redesigned-user-role-select">
                    {/* Clear option */}
            ...
            render={({ field }: any) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} value={field.value} disabled={mode === 'profile'}>
                  ...
                  <SelectContent selectId="redesigned-user-auth-type-select">
