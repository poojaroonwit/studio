...
export function AttachmentsTab({
  ...
  const handleDownload = async (attachment: Attachment) => {
    try {
      const response = await fetch(`/api/applicants/${applicantId}/resumes/${attachment.id}/download`);
  ...
  const handleDelete = async (attachmentId: string) => {
    ...
    try {
      const response = await fetch(`/api/applicants/${applicantId}/resumes/${attachmentId}`, {
        method: 'DELETE',
      });
