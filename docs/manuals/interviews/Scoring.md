...
| Feature | Description |
| :--- | :--- |
| **What** | A quantitative and qualitative assessment of a candidate's skills and cultural fit. |
...
| **Why** | To ensure every candidate is judged against the same criteria and to provide the recruitment team with actionable data for the final hiring decision. |
| **Where** | Inside the **Candidate Profile** under the **"Start Evaluation"** action button. |
| **How** | 1. Open Candidate Profile <br> 2. Click **"Start Evaluation"** <br> 3. Rate Skills (1-5 Stars) <br> 4. Add Strengths/Red Flags <br> 5. Click **"Submit Scorecard"** |
...
2. **Key Strengths**: Provide bullet points on specific examples where the candidate exceeded expectations.
...
1.  **Navigate**: Go to a candidate profile where you are an interviewer.
