...
export const EducationTab: React.FC<EducationTabProps> = ({
  ...
  const education = (applicant.parsedData && 'education' in (applicant.parsedData as any))
    ? (Array.isArray((applicant.parsedData as any).education) ? (applicant.parsedData as any).education : [])
    : [];
