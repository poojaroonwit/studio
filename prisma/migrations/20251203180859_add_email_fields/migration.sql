-- Add email-related fields to applicant table
ALTER TABLE "applicant" ADD COLUMN IF NOT EXISTS "emailDate" TIMESTAMP(3);
ALTER TABLE "applicant" ADD COLUMN IF NOT EXISTS "emailSubject" TEXT;
ALTER TABLE "applicant" ADD COLUMN IF NOT EXISTS "emailId" TEXT;
ALTER TABLE "applicant" ADD COLUMN IF NOT EXISTS "emailMetadata" JSONB;
...
CREATE INDEX IF NOT EXISTS "applicant_emailDate_idx" ON "applicant"("emailDate");
CREATE INDEX IF NOT EXISTS "applicant_emailId_idx" ON "applicant"("emailId");
