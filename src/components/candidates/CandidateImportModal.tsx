...
export default function CandidateImportModal({ isOpen, onOpenChange, onImportSuccess }: CandidateImportModalProps) {
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      toast.error((error as Error).message || 'Failed to import candidates');
    } finally {
    ...
    <Dialog open={isOpen} onOpenChange={handleModalClose}>
      <DialogContent className="sm:max-w-[800px]" dialogId="candidate-import-modal">
        <DialogHeader>
          ...
          <DialogDescription>
            Import candidates from an Excel file. You can update existing candidates by including their ID, or create new ones by leaving the ID field blank.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="text-sm text-muted-foreground space-y-2">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p>• Leave blank to create new candidates</p>
                  <p>• Provide existing UUID to update candidates</p>
                </div>
              </div>
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p>• Name* and Email* are required for all candidates</p>
