          ...
          {statistics && (
            <ScrollArea className="h-full px-6 py-4">
              <div className="space-y-4">
                ...
                {/* Positions Without SLA */}
                {positionsWithoutSLA.length > 0 && (
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-medium">Positions Without SLA</h4>
                      <Badge variant="outline" className="text-xs">
                        {positionsWithoutSLA.length}
                      </Badge>
                    </div>
                    <div className="space-y-2">
                      ...
                      {positionsWithoutSLA.length > 5 && (
                        <div className="text-center py-2">
                          <p className="text-xs text-muted-foreground">
                            +{positionsWithoutSLA.length - 5} more positions without SLA
                          </p>
                        </div>
                      )}
                    </div>
