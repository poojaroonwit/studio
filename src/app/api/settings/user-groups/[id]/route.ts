...
const errorPermissions = [
  'APPLICANTS_VIEW', 'APPLICANTS_VIEW_DETAILED', 'APPLICANTS_CREATE', 'APPLICANTS_EDIT_BASIC', 
  'APPLICANTS_EDIT_SENSITIVE', 'APPLICANTS_DELETE', 'APPLICANTS_RESUMES_UPLOAD', 'APPLICANTS_RESUMES_DELETE',
